...
namespace estate_executor{
    ...
    int assemble_code(){
        int allBlue = zhang::blue::code_fragment() + khan::blue::code_fragment() + garcia::blue::code_fragment();
        int allRed = zhang::red::code_fragment() + khan::red::code_fragment() + garcia::red::code_fragment();
        return allBlue * allRed;
    }
}